...
tag_list = raw_input("What tags would you like to add? Split tags with commas. ")
...
def createApp(rtm):
    ...
    with open(file_name) as csvfile:
        ...
        for i in tasks:
            rspSetName = rtm.tasks.addTags(timeline= timelineNum, list_id= i[0], taskseries_id= i[1],
            task_id= i[2], tags=tag_list)
